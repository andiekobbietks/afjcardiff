...
if(count($_FILES["file"]["name"]) > 0)
{
    ...
    for($count=0; $count<count($_FILES["file"]["name"]); $count++)
    {
        ...
        {
            $query = "
            INSERT INTO classes (code_basedtitle, class_title, class_description, class_image, expected_startdatetime, expected_enddatetime) 
            VALUES ('code', 'title', 'description', '".$file_name."', NOW(), NOW())
            ";
