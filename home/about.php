...
<section class="site_hero inner-page overlay" style="background-image: url(<?php echo aboutusbackground($connect); ?>);">
    <div class="container">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
			...
			<?php echo aboutus($connect); ?>
          </div>
			<?php echo aboutusdesciption($connect); ?>
        </div>
      </div>
    </section>  
	<section class="py-5 bg-light" id="next">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
			...
			<?php echo aboutusmissionimage($connect); ?>
          </div>
			<?php echo aboutusmission($connect); ?>
        </div>
      </div>
    </section>	
    ...
    <div class="container section">
      <div class="row justify-content-center text-center mb-5">
        <div class="col-md-7 mb-5">
          <h2 class="heading" data-aos="fade-up" style="color: white;">Leadership</h2>
        </div>
      </div>

      <div class="row">
			<?php echo aboutusleadership($connect); ?>
      </div>
    </div>
    ...
    <div class="section bg-light">
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
			<?php echo aboutushistory($connect); ?>
          </div>
        </div>
